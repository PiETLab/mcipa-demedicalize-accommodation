# Pathway: Tier-Intro Initial Setup II (Sabine)

## Purpose

Provide a step-by-step guide to improve on the initial setup (Setup I).
Set up the basic method for 'commit-and-push' using the Obsidian (replace commit-and-sync using Github Desktop).
The goal is to publish directly from Obsidian and eliminate the need for two separate tools.
...
- [ ] Vault is connected to repository and can pull
- [ ] One test edit was committed and pushed from Obsidian
- [ ] GitHub shows the commit
- [ ] Public site reflects the change after automatic rebuild
- [ ] Escalation points are understood

## Escalate when

- authentication prompts repeat
- push is rejected due to remote updates
- site does not update after successful workflow completion
